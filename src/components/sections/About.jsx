  ...
  return (
    <section id="about" className="py-16 px-4 sm:px-6 lg:px-8 bg-white">
      <div className="max-w-6xl mx-auto">
        <h1 className="text-3xl md:text-4xl font-bold text-gray-800 mb-12 text-center flex items-center justify-center" data-aos="fade-up">
          <FaUser className="mr-3 text-blue-600" />
          About Me
        </h1>

        <div className="flex flex-col lg:flex-row items-center gap-8 xl:gap-12">
          <div className="relative group flex-shrink-0" data-aos="fade-right" data-aos-delay="200">
            ...
            <img src={HariNorway} alt="Hari Bhusal" className="rounded-2xl w-64 h-64 md:w-80 md:h-80 object-cover border-4 border-white shadow-lg transform transition duration-500 hover:scale-105" />
          </div>
