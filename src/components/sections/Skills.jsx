...
import windchill from "../../assets/images/Windchill.svg";
      ...
      <div data-aos="fade-down" data-aos-duration="800" data-aos-anchor-placement="center-bottom">
        <div className="flex flex-wrap mt-5 justify-center">
          ...
          <div style={cardStyle} className="group relative flex flex-col items-center p-6 rounded-xl shadow-2xl mr-4 mb-4 transition-all duration-300 hover:scale-105 bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-sm border border-white/20 hover:border-blue-400/30">
            ...
            <FontAwesomeIcon icon={faJs} className="z-10 drop-shadow-lg" style={{ color: "#f0db4f" }} size="4x" />
          ...
          <div style={cardStyle} className="group relative flex flex-col items-center p-6 rounded-xl shadow-2xl mr-4 mb-4 transition-all duration-300 hover:scale-105 bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-sm border border-white/20 hover:border-blue-400/30">
            ...
            <FontAwesomeIcon icon={faReact} className="z-10 drop-shadow-lg" style={{ color: "#61dafb" }} size="4x" />
        ...
        <div className="flex flex-wrap mt-4 justify-center">
          <div style={cardStyle} className="group relative flex flex-col items-center p-6 rounded-xl shadow-2xl mr-4 mb-4 transition-all duration-300 hover:scale-105 bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-sm border border-white/20 hover:border-blue-400/30">
            ...
            <SiTailwindcss className="z-10 drop-shadow-lg" size={60} color="#06b6d4" />
          ...
          <div style={cardStyle} className="group relative flex flex-col items-center p-6 rounded-xl shadow-2xl mr-4 mb-4 transition-all duration-300 hover:scale-105 bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-sm border border-white/20 hover:border-blue-400/30">
            ...
            <FontAwesomeIcon icon={faCss3Alt} className="z-10 drop-shadow-lg" style={{ color: "#264de4" }} size="4x" />
          ...
          <div style={cardStyle} className="group relative flex flex-col items-center p-6 rounded-xl shadow-2xl mr-4 mb-4 transition-all duration-300 hover:scale-105 bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-sm border border-white/20 hover:border-blue-400/30">
            ...
            <img src={git} alt="git Logo" width={60} height={60} className="z-10 drop-shadow-lg" />
          ...
          <div style={cardStyle} className="group relative flex flex-col items-center p-6 rounded-xl shadow-2xl mr-4 mb-4 transition-all duration-300 hover:scale-105 bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-sm border border-white/20 hover:border-blue-400/30">
            ...
            <img src={github} alt="github Logo" width={60} height={60} className="z-10 drop-shadow-lg" />
