...
//   const handleSubmit = (e) => {
//     e.preventDefault();
//     // EmailJS integration remains the same
//   };
...
//                     <IoIosContact className="w-6 h-6 text-gray-400 dark:text-gray-300" />
//                   </div>
//                   <input
//                     type="text"
//                     id="name"
...
//                     className="w-full pl-10 pr-4 py-3 rounded-lg border-2 border-gray-200 dark:border-gray-600 focus:border-blue-500 focus:outline-none focus:ring-2 focus:ring-blue-200 bg-transparent transition-all"
//                     value={formData.name}
//                     onChange={handleChange}
//                     required
//                   />
...
//                 <div className="relative">
//                   <div className="flex absolute inset-y-0 left-0 items-center pl-3 pointer-events-none">
//                     <FaPhoneAlt className="w-6 h-6 text-gray-400 dark:text-gray-300" />
//                   </div>
//                   <input
//                     type="tel"
//                     id="phone"
...
//                       <MdMessage className="w-6 h-6 text-gray-400 dark:text-gray-300" />
//                     </div>
//                     <textarea
//                       id="message"
//                       name="message"
...
//                       className="w-full pl-10 pr-4 py-3 rounded-lg border-2 border-gray-200 dark:border-gray-600 focus:border-blue-500 focus:outline-none focus:ring-2 focus:ring-blue-200 bg-transparent resize-none transition-all"
//                       value={formData.message}
//                       onChange={handleChange}
//                       required
//                     ></textarea>
...
//                 <button
//                   type="submit"
//                   className="w-full flex items-center justify-center gap-2 px-6 py-3 bg-blue-500 hover:bg-blue-600 text-white font-semibold rounded-lg transition-all duration-300 transform hover:scale-[1.02] shadow-lg hover:shadow-xl"
//                 >
//                   Send Message
//                   <IoIosSend className="w-5 h-5" />
//                 </button>
